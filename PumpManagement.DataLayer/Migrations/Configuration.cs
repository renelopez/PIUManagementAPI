...
namespace PumpManagement.DataLayer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<PumpManagement.DataLayer.PumpManagementContext>
    {
        ...
        protected override void Seed(PumpManagement.DataLayer.PumpManagementContext context)
        {
            ...
            var pumpers = new List<Pumper>
            {
                new Pumper
                {
                    ...
                    Phone = "360321212",
                    BirthDate = DateTime.ParseExact("24/04/1988","dd/MM/yyyy",null),
                    CaloriesBurned = 20,
                    DebutDate = DateTime.ParseExact("12/12/2006","dd/MM/yyyy",null),
                 ...
                 new Pumper
                {
                    ...
                    Phone = "360321212",
                    BirthDate = DateTime.ParseExact("12/04/1989","dd/MM/yyyy",null),
                    CaloriesBurned = 23432,
                    DebutDate = DateTime.ParseExact("12/12/1992","dd/MM/yyyy",null),
                  ...
                  new Pumper
                {
                    ...
                    Phone = "360321212",
                    BirthDate = DateTime.ParseExact("12/04/1994","dd/MM/yyyy",null),
                    CaloriesBurned = 23432,
                    DebutDate = DateTime.ParseExact("12/12/2010","dd/MM/yyyy",null),
                   ...
                   new Pumper
                {
                    ...
                    BirthDate = DateTime.ParseExact("12/04/1989","dd/MM/yyyy",null),
                    CaloriesBurned = 23432,
                    DebutDate = DateTime.ParseExact("12/12/1990","dd/MM/yyyy",null),
                    ...
                    new Pumper
                {
                    ...
                    Phone = "360321212",
                    BirthDate = DateTime.ParseExact("12/04/1992","dd/MM/yyyy",null),
                    CaloriesBurned = 23432,
                    DebutDate = DateTime.ParseExact("12/12/1990","dd/MM/yyyy",null),
